...
class MaxSumSubMatrix
{
    static void Main()
    {
        ...
        int bestRow = 0;//start of sub-matrix -row
        int bestCol = 0;//start of sub-matrix -column
        ...
        Console.WriteLine(" {0} {1} {2}", matrix[bestRow + 2, bestCol], matrix[bestRow + 1, bestCol + 1], matrix[bestRow + 2, bestCol + 2]);
